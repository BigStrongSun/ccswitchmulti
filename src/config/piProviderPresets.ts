  ...
  },
  {
    ...
    settingsConfig: {
      ...
      models: [
        ...
        piModel("qwen/qwen3.6-plus", { id: "qwen3.6-plus" }),
        piModel("qwen/qwen3.6-flash", { id: "qwen3.6-flash" }),
      ],
    },
    category: "cn_official",
    icon: "qwen",
  ...
  },
  {
    ...
    settingsConfig: {
      ...
      models: [
        piModel("qwen/qwen3.7-plus", { id: "qwen3.7-plus" }),
        piModel("qwen/qwen3.6-plus", { id: "qwen3.6-plus" }),
        piModel("qwen/qwen3.5-plus", { id: "qwen3.5-plus" }),
        piModel("qwen/qwen3-max-2026-01-23", {
          id: "qwen3-max-2026-01-23",
        }),
        piModel("qwen/qwen3-coder-next", { id: "qwen3-coder-next" }),
        piModel("qwen/qwen3-coder-plus", {
          id: "qwen3-coder-plus",
