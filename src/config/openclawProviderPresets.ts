  ...
  },
  {
    ...
    suggestedDefaults: {
      ...
      modelCatalog: {
        ...
        "qwencloud/qwen3.6-flash": { alias: "Qwen3.6 Flash" },
      },
    },
  },
  {
    ...
    templateValues: {
      ...
      apiKey: { label: "API Key", placeholder: "sk-sp-...", editorValue: "" },
    },
    suggestedDefaults: {
      ...
      modelCatalog: {
        ...
        "qwencloud-coding/qwen3.5-plus": { alias: "Qwen3.5 Plus" },
        "qwencloud-coding/qwen3-max-2026-01-23": {
          alias: "Qwen3 Max 2026-01-23",
        },
        "qwencloud-coding/qwen3-coder-next": { alias: "Qwen3 Coder Next" },
