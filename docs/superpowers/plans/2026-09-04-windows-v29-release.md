...
- [ ] Bump package.json, Cargo.toml, Cargo.lock and tauri.conf.json to 3.19.2-29 and commit candidate identity.
- [ ] Run frontend tests/typecheck/format, Rust tests/check/format and installation-transaction tests.
