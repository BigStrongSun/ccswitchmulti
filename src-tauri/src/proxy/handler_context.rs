...
pub struct RequestContext {
    ...
    /// Whether a trusted local Codex Desktop caller needs summary-backed
    /// reasoning presentation for third-party raw reasoning.
    pub codex_desktop_reasoning: bool,
    /// 整流器配置
...
impl RequestContext {
    ...
    pub async fn new(
        ...
        let codex_desktop_reasoning = crate::proxy::providers::is_codex_desktop_reasoning_client(
            headers,
