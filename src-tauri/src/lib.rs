...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::migrate_codex_official_auth_ownership,
            ...
            commands::get_codex_official_fallback_models,
            ...
            commands::restore_codex_provider_protocol_evidence,
            commands::preflight_universal_codex_protocol_compatibility,
            commands::save_codex_provider_with_protocol_preflight,
            commands::prepare_codex_provider_set,
            commands::commit_codex_provider_set,
            ...
            commands::save_and_sync_universal_provider,
            commands::prepare_universal_provider_set,
            commands::commit_universal_provider_set,
            // OpenCode specific
